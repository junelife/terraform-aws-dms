...
resource "aws_iam_role" "dms_access_for_endpoint" {
  ...
  name = (
    var.iam_role_name_prefix != null
    ? "${var.iam_role_name_prefix}-dms-access-for-endpoint"
...
resource "aws_iam_role" "dms_cloudwatch_logs_role" {
  ...
  name = (
    var.iam_role_name_prefix != null
    ? "${var.iam_role_name_prefix}-dms-cloudwatch-logs-role"
...
resource "aws_iam_role" "dms_vpc_role" {
  ...
  name = (
    var.iam_role_name_prefix != null
    ? "${var.iam_role_name_prefix}-dms-vpc-role"
    : "dms-vpc-role"
  )
